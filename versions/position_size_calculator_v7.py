...
class FPSCApp(tk.Tk):
    def __init__(self):
        ...
        # ---- Declare all StringVars and variables up front ----
        ...
        self.active_field = None  # Track the master input field
        ...
        # Risk per Trade (entry, %/$ label, radio buttons, all in one row)
        ...
        self.percent_btn = ttk.Radiobutton(risk_frame, text="Percent", variable=self.risk_mode, value="percent")
        self.percent_btn.pack(side="left", padx=(6,0))
        self.dollars_btn = ttk.Radiobutton(risk_frame, text="Dollars", variable=self.risk_mode, value="dollars")
        ...
        # Contracts to Trade (bi-directional input)
        ...
        # --- Focus bindings for one-way input logic ---
        ...
        # ---- Only after all variables/widgets: ----
